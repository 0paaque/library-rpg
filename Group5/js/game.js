...
joystickBase.addEventListener("touchmove", (e) => {
    ...
    joystickStick.style.transform = `translate(${moveX}px, 0px)`
})
...
function showChoiceUI(options) {
    ...
    container.style.border = "2px solid #c8b27d"
    container.style.zIndex = "10000"
    container.style.color = "white"
    container.style.width = "80%"
    container.style.borderRadius = "10px"

    container.innerHTML = `<b>What will you do?</b><br><br>`
    ...
    options.forEach(opt => {
        ...
        btn.style.border = "1px solid #c8b27d"
